...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2022b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := sldrtex_vdp
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c sldrtex_vdp_data.c sldrtex_vdp_tgtconn.c
MAKEFILE             := sldrtex_vdp.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2022b/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sldrtex_vdp_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/Marek/Desktop/DIPLOM~1;C:/Users/Marek/Desktop/DIPLOM~1/sldrtex_vdp_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
...
PRECOMPLIBSRCDIRS := $(MATLAB_ROOT)/rtw/c/src $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/rtw/c/src/ext_mode/common 
