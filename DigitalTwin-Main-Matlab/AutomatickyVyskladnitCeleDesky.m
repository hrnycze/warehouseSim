function AutomatickyVyskladnitCeleDesky
    ...
    automatickePreskladneniOkno = uifigure('Name', 'Aut. přeskladnění - cele desky', 'Position', [700, 350, 550, 500]);
    ...
    temp = pozice_typ_ID((IO_pocet+1):length(pozice_typ_ID)-skladove_pozice_pocet);
    for i = 1: length(temp)
