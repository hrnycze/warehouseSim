...
/*-------------*/
    ...
    {
        public ulong size;           /* ファイルサイズ(byte) */
        public byte min;           /* タイムスタンプ(分) */
        public byte hour;          /* タイムスタンプ(時) */
        public byte day;           /* タイムスタンプ(日) */
        public byte month;         /* タイムスタンプ(月) */
        public ushort year;          /* タイムスタンプ(年) */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
    ...
    public class ODBMDL
    {
        public short datano;
        public short type;
        public ODBMDL_U modal;

        [StructLayout(LayoutKind.Explicit)]
        public struct ODBMDL_U
        {
            [FieldOffset(0),
            MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public byte[] g_1shot;
    ...
    /* cnc_rdservoid2:Read servo id info(2) */
    /* cnc_rdfromservoid2:Read from servo id info(2) */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBCSVID2
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 20)]
        public char[] mt_spc = new char[20];    /* Servo motor specification  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
        public char[] mt_srn = new char[10];    /* Servo motor serial number  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 22)]
        public char[] plc_spc = new char[22];   /* Pulse coder specification  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]
        public char[] plc_srn = new char[9];    /* Pulse coder serial number  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 22)]
        public char[] svm_spc = new char[22];   /* SV specification           */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
        public char[] svm_srn = new char[12];   /* SV serial number           */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 22)]
        public char[] psm_spc = new char[22];   /* PS specification           */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
        public char[] psm_srn = new char[12];   /* PS serial number           */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]
        public char[] svs_see = new char[9];    /* SV software series edition */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]
        public char[] pss_see = new char[9];    /* PS software series edition */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 22)]
        public char[] pm1_spc = new char[22];   /* Separator 1 specification  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]
        public char[] pm1_srn = new char[9];    /* Separator 1 serial number  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 22)]
        public char[] pm2_spc = new char[22];   /* Separator 2 specification  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)]
        public char[] pm2_srn = new char[9];    /* Separator 2 serial number  */
    }

    /* cnc_rdspindleid2:Read spindle id info(2) */
    /* cnc_rdfromspindleid2:Read from spindle id info(2) */
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public class ODBCSPID2
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 20)]
        public char[] mt_spc = new char[20];    /* Main SP motor specification */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
        public char[] mt_srn = new char[10];    /* Main SP motor serial number */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 20)]
        public char[] sbmt_spc = new char[20];  /* Sub SP motor specification  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)]
        public char[] sbmt_srn = new char[10];  /* Sub SP motor serial number  */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 22)]
        public char[] spm_spc = new char[22];   /* SP specification            */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
        public char[] spm_srn = new char[12];   /* SP serial number            */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 22)]
        public char[] psm_spc = new char[22];   /* PS specification            */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
        public char[] psm_srn = new char[12];   /* PS serial number            */
    ...
    public class IODBPSCD_data
    {
        ...
        public int     displace2;
        public char    gap_axis;
        public char    feed_dec ;
        public char    supple_dec ;
        public char    dsp2_dec;
    }
    [StructLayout(LayoutKind.Sequential,Pack=4)]
    ...
    /* cnc_rdpscdedge2:read processing condition file (edging data) */
    /* cnc_wrpscdedge2:write processing condition file (edging data) */
    [StructLayout(LayoutKind.Sequential,Pack=4)]
    public class IODBEDGE2_data
    {
        ...
        public short    r_duty;
        public char     gap_axis;
        public char     angle_dec;
        public char     gap_dec;
        public char     r_len_dec;
        public char     r_feed_dec;
        public char     reserve;
        public short    pb_power ;
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=2)]
    ...
    /* cnc_rdlpscdpwrctl:read processing condition file (power control data)  */
    /* cnc_wrlpscdpwrctl:write processing condition file (power control data) */
    [StructLayout(LayoutKind.Sequential,Pack=4)]
    ...
    public class ODBLCMDT
    {
        ...
        public char    gap_axis;
        public char    feed_dec;
        public char    dsplc_dec;
        public char    error2_dec;
        public short   pb_power ;
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=2)]
...
//      ref short a, short b, ref short c, ref short d, [Out,MarshalAs(UnmanagedType.LPStruct)] ODBDGN e );
    ...
    [DllImport("FWLIB64.dll", EntryPoint = "cnc_rdservoid2")]
    public static extern short cnc_rdservoid2(ushort FlibHndl, short axis, short type, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBCSVID2 servoid);

    [DllImport("FWLIB64.dll", EntryPoint = "cnc_rdspindleid2")]
    public static extern short cnc_rdspindleid2(ushort FlibHndl, short sp, short type, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBCSPID2 spindleid);

    [DllImport("FWLIB64.dll", EntryPoint = "cnc_rdfromservoid2")]
    public static extern short cnc_rdfromservoid2(ushort FlibHndl, short axis, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBCSVID2 servoid);

    [DllImport("FWLIB64.dll", EntryPoint = "cnc_rdfromspindleid2")]
    public static extern short cnc_rdfromspindleid2(ushort FlibHndl, short sp, [Out, MarshalAs(UnmanagedType.LPStruct)] ODBCSPID2 spindleid);
    ...
    /* read processing condition file (processing data) */
    [DllImport("FWLIB64.dll", EntryPoint="cnc_rdpscdproc2")]
    ...
    /* write processing condition file (processing data) */
    [DllImport("FWLIB64.dll", EntryPoint="cnc_wrpscdproc2")]
    ...
    /* read processing condition file (edging data)(2) */
    [DllImport("FWLIB64.dll", EntryPoint="cnc_rdpscdedge2")]
    ...
    /* write processing condition file (edging data)(2) */
    [DllImport("FWLIB64.dll", EntryPoint="cnc_wrpscdedge2")]
    ...
    [DllImport("FWLIB64.dll", EntryPoint="cnc_rdlpscdpwrctl")]
    ...
    [DllImport("FWLIB64.dll", EntryPoint="cnc_wrlpscdpwrctl")]
...
/*-----*/
    ...
    public static extern short pmc_rdpmcrng(ushort FlibHndl,
        short a, short b, ushort c, ushort d, ushort e, [Out,MarshalAs(UnmanagedType.LPStruct)] IODBPMC4 f );
    [DllImport("FWLIB32.dll", EntryPoint = "pmc_rdpmcrng")]
    public static extern short pmc_rdpmcrng(ushort FlibHndl,
        short a, short b, ushort c, ushort d, ushort e, [Out,MarshalAs(UnmanagedType.LPStruct)] IODBPMC5 f );
    [DllImport("FWLIB64.dll", EntryPoint="pmc_rdpmcrng")]
    ...
    public static extern short pmc_wrpmcrng(ushort FlibHndl, ushort a, [In, MarshalAs(UnmanagedType.LPStruct)] IODBPMC4 b );
    [DllImport("FWLIB32.dll", EntryPoint = "pmc_wrpmcrng")]
    public static extern short pmc_wrpmcrng(ushort FlibHndl, ushort a, [In, MarshalAs(UnmanagedType.LPStruct)] IODBPMC5 b );
    [DllImport("FWLIB64.dll", EntryPoint="pmc_wrpmcrng")]
...
/*---------------------*/
    ...
    //public static extern short cnc_rdmcdfinfo(ushort FlibHndl, long file_no, ref ODBFILESTATUS a);
...
public class OUT_ETHPRM_DTSVR
{
    ...
    public short DtsvrChannel;
    public short Storage;
    public DTSVR_PRM    dtsvr;
} ;

    /* read the parameter of the Ethernet board */
    [DllImport("FWLIB64.dll", EntryPoint="eth_rdparam")]
...
{
    public char    op1HostName;
    public char    op1ControlPort;
    public char    op1Dummy;
    public char    op1UserName;
    public char    op1Password;
    public char    op1LoginDirectory;
    public char    op2HostName;
    public char    op2ControlPort;
    public char    op2Dummy;
    public char    op2UserName;
    public char    op2Password;
    public char    op2LoginDirectory;
    public char    op3HostName;
    public char    op3ControlPort;
    public char    op3Dummy;
    public char    op3UserName;
    public char    op3Password;
...
public class IN_ETHPRM_DTSVR
{
    ...
    /* write the parameter of the Ethernet board */
    [DllImport("FWLIB64.dll", EntryPoint="eth_wrparam")]
